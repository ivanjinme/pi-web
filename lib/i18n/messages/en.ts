...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.hide": "Hide",
    "settings.show": "Show",
    "settings.globalResources": "Global resources",
    "settings.helpFeedback": "Help & Feedback",
    "settings.logout": "Logout",
    "settings.advancedFeature": "Advanced feature",
    "settings.openProjectForScope": "Open a project to use project scope",
    "settings.version": "Version",
    "settings.webVersion": "Web ",
    "settings.piVersion": "Pi ",
    "sidebar.hide": "Hide sidebar",
    "sidebar.show": "Show sidebar",
    "theme.light": "Switch to light mode",
    "theme.dark": "Switch to dark mode",
    "history.full": "Trace",
    "history.unsaved": "Trace is available after the session is saved",
    "history.label": "Trace",
    ...
    "workspace.addModels": "Add models in Settings",
    "workspace.stepProject": "Select a project directory from the sidebar",
    "workspace.stepModels": "Add models in Settings",
    ...
    "chat.chooseProjectHint": "Choose a project or send with the default workspace",
    "chat.clearProject": "Clear project selection",
    "chat.searchProjects": "Search projects",
    "chat.newProject": "New project",
    "chat.noProjectMode": "Don't work in a project",
    "chat.noMatchingProjects": "No matching projects",
    "chat.editQueued": "Edit pending message",
    "chat.deleteQueued": "Delete pending message",
    ...
    "chat.steerPlaceholder": "Enter to steer · Alt+Enter to follow up",
    "chat.agentPlaceholder": "Agent is running…",
    "chat.messagePlaceholder": "How can I help you? @ or directly paste to reference files, / to invoke skills.",
    "chat.steer": "Steer",
    ...
    "i18n.diagnosticCount": "{count} diagnostics",
    ...
    "i18n.conversationCompacted": "Context compacted",
