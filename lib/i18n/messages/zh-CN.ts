...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.light": "浅色",
    "settings.dark": "深色",
    "settings.sessionDiagnostics": "会话诊断信息",
    "settings.completionSound": "完成提示音",
    "settings.on": "开启",
    "settings.off": "关闭",
    "settings.hide": "隐藏",
    "settings.show": "显示",
    "settings.globalResources": "全局资源",
    "settings.helpFeedback": "帮助与反馈",
    "settings.logout": "退出登录",
    "settings.advancedFeature": "高级功能",
    "settings.openProjectForScope": "打开项目以使用项目范围",
    "settings.version": "版本",
    ...
    "theme.dark": "切换到深色模式",
    "history.full": "Trace",
    "history.unsaved": "会话保存后才能查看 Trace",
    "history.label": "Trace",
    ...
    "workspace.addModels": "在设置中添加模型",
    "workspace.stepProject": "从侧边栏选择项目目录",
    "workspace.stepModels": "在设置中添加模型",
    ...
    "chat.chooseProjectHint": "选择项目，或直接使用默认工作区发送",
    "chat.clearProject": "清除项目选择",
    "chat.searchProjects": "搜索项目",
    "chat.newProject": "新建项目",
    "chat.noProjectMode": "不使用项目模式",
    "chat.noMatchingProjects": "无匹配项目",
    "chat.editQueued": "编辑待处理消息",
    "chat.deleteQueued": "删除待处理消息",
    ...
    "chat.steerPlaceholder": "Enter 发送 Steer · Alt+Enter 发送 Follow up",
    "chat.agentPlaceholder": "Agent 运行中…",
    "chat.messagePlaceholder": "需要帮你做些什么？@ 或直接粘贴引用文件，/ 调用技能",
    "chat.steer": "引导",
    "chat.followUp": "后续消息",
    "chat.send": "发送",
    ...
    "i18n.path": "路径",
    "i18n.examples": "示例",
    "i18n.diagnosticCount": "{count} 条诊断",
    ...
    "i18n.noOutput": "（无输出）",
    "i18n.noSummary": "（无摘要）",
    "i18n.conversationCompacted": "上下文已压缩",
