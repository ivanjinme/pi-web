...
function streamFile(filePath: string, stat: fs.Stats, contentType: string, rangeHeader: string | null, asDownload = false): Response {
  ...
  // repo-controlled SVG navigated to directly could otherwise run script in
  // the Pi Web origin. These headers only affect document rendering; <img>
  // preview embedding ignores them.
