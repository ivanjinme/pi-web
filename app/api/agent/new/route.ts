...
export async function POST(req: Request) {
  try {
    ...
    const { provider, modelId, toolNames, toolPreset, thinkingLevel, ...promptCommand } = command as { provider?: string; modelId?: string; toolNames?: string[]; toolPreset?: ToolPreset; thinkingLevel?: string; [key: string]: unknown };
